...
export default function ButtonGoogleLogin() {
  ...
  return (
    <Button
      className="relative flex items-center justify-center w-full h-14 px-4 bg-white text-gray-700 rounded-xl transition-all duration-200 hover:shadow-[0_0_0_2px_#13ec5b] hover:-translate-y-0.5 border border-transparent group"
      onClick={handleLogin}
    >
